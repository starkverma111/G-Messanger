    ...
    <div class="container mt-5 p-0 m-auto border rounded shadow-sm p-3 mb-5 bg-body rounded rounded-3" style="width:795px;">
      <div class="row p-5 ">
        <div class="col-md-7 ps-3 pe-3">
          ...
          <div class="row">
            <h4 class="mb-3 mt-1 " style="margin-left: -4px;">Create your Google Account</h4>
            <div class="col p-2 m-0">
              <label for="exampleInputEmail1" class="form-label">First name</label>
              <input type="text" class="form-control p-2" ng-model="fname">
            </div>
            <div class="col p-2 m-0">
              <label for="exampleInputEmail1" class="form-label">Last Name</label>
              <input type="text" class="form-control p-2" ng-model="lname">
            </div>
            <div class="p-2">
              <label for="exampleInputPassword1" class="form-label">Email address</label>
              <input type="email" class="form-control p-2" ng-model="email">
            </div>
            <div class="row p-0 m-0">
              ...
              <div class="col p-2 m-0">
                ...
                <input type="{{inputType}}" class="form-control p-2" ng-model="repassword">
              </div>
            ...
            <div class="row mt-4 p-0 m-0">
              <div class="col text-primary fw-bold d-flex align-items-center " id="txt"><a href="./login.php" class="text-decoration-none">Log In instead</a></div>
              <div class="col d-flex justify-content-end p-0 m-0 me-2">
                <button type="button" class=" btn btn-primary fw-normal text-end" id="btn" ng-click="register()">Sign Up</button>
              </div>
            </div>
          </div>
        </div>
...
<script>
 ...
 //this function for register...	
		app.controller("Aregister", function($scope, $http, $timeout){ 
		$scope.register = function() {
				$http.post("verify_register.php", {
					'fname': $scope.fname, //$scope.fname GET DATA FROM YOUR HTML FORM
					'lname': $scope.lname, //$scope.fname GET DATA FROM YOUR HTML FORM
					'email': $scope.email, //$scope.fname GET DATA FROM YOUR HTML FORM
					'password': $scope.password, //$scope.fname GET DATA FROM YOUR HTML FORM						
					'repassword': $scope.repassword //$scope.fname GET DATA FROM YOUR HTML FORM
