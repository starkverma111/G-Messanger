<div ng-controller="A_update_details"> 
          ...
          <div class="row ps-5 pe-5 pt-1 ms-5 me-5">
            ...
            <div class="col p-2 m-0">
              ...
              <input type="text" class="form-control p-2" ng-model="fnamee">
            </div>
            <div class="col p-2 m-0">
              <label for="exampleInputEmail1" class="form-label">Last Name</label>
              <input type="text" class="form-control p-2" ng-model="lnamee">
            </div>
            <div class="p-2">
              <label for="exampleInputPassword1" class="form-label">Email address</label>&nbsp;&nbsp;&nbsp;&nbsp;<small class="text-muted">you can not change your email up to 6 months</small>
              <input type="email" class="form-control p-2" ng-model="email" disabled />
            </div>
            <div class="row p-0 m-0">
              <div class="col p-2 m-0">
                <label for="exampleInputEmail1" class="form-label">Enter you Password to update details</label>
                <input type="{{inputType}}" class="form-control p-2" ng-model="ck_password">
              </div>
			  ...
			  <p ng-bind="showe" class="text-danger"></p>
            ...
            <div class="row mt-4 p-0 m-0">
			  ...
			  <button type="button" class="btn btn-link text-decoration-none" ng-click="resetForm()">Reset</button>
			  </div>
              <div class="col d-flex justify-content-end p-0 m-0 me-2">
                <button type="button" class=" btn btn-primary fw-normal text-end" id="btn" ng-click="changeDetails()">Update Details</button>
              </div>
            </div>
          </div>
